    ...
    <BrowserRouter>
      ...
      <div className="App">
        <Routes>
          ...
          <Route
            path="/home"
            element={<Home addItemToCart={cartProps.addItem} />}
          />
          ...
          <Route
            path="/checkout"
            element={<Checkout cartProps={cartProps} />}
          />

          <Route
            path="/favorites"
            element={<Favorites favoritesProps={favoritesProps} />}
          />
